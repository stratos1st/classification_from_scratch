...
extern std::list <my_vector>* read_vector_file(std::string name, unsigned int max_curve_points=0);//max_curve_points den kani tipota!
template <typename T>
...
extern std::list <my_curve>* read_curve_file(std::string name, unsigned int max_curve_points=0);
